...
current_path=$home_path/SPD/scripts/randomCutData/$versionum
...
cv_scp_path=$scp_path/$target_dir/cv/$mfcc_type
test_scp_path=$scp_path/$target_dir/test/$mfcc_type
train_scp_path=$scp_path/$target_dir/train/$mfcc_type

label_path=$home_path/label
cv_label_path=$label_path/$target_dir/cv/$mfcc_type
test_label_path=$label_path/$target_dir/test/$mfcc_type
train_label_path=$label_path/$target_dir/train/$mfcc_type
...
cp $label_path/$target_dir/${target_dir}.lab $train_label_path/frame_train.lab
...
########this is for mfcc a and b type
		...
		do
			...
			awk '$1 ~ /^'${languageline}_${arg}'$/ {print $0 >> "'$test_label_path/test.lab'"}' $label_path/$target_dir/${target_dir}.lab
		...
		do
			...
			awk '$1 ~ /^'${languageline}_${arg}'$/ {print $0 >> "'$cv_label_path/cv.lab'"}' $label_path/$target_dir/${target_dir}.lab
			sed '/^'${languageline}_${arg}'/'d $train_label_path/frame_train.lab > $train_label_path/frame_train_tmp.lab
			rm -rf $train_label_path/frame_train.lab
			mv $train_label_path/frame_train_tmp.lab $train_label_path/frame_train.lab
